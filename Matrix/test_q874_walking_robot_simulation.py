...
from Matrix.q874_walking_robot_simulation import Solution


class TestWalkingRobotSimulation(unittest.TestCase):
    """Test q874_walking_robot_simulation.py"""

    def test_walking_robot_simulation(self):
        s = Solution()

        # self.assertEqual(25, s.robotSim([4, -1, 3], []))
        # self.assertEqual(65, s.robotSim([4, -1, 4, -2, 4], [[2, 4]]))
        # self.assertEqual(0, s.robotSim([-2, -1, 8, 9, 6],
        #                                [[-1, 3], [0, 1], [-1, 5], [-2, -4], [5, 4], [-2, -3], [5, -1], [1, -1], [5, 5],
        #                                 [5, 2]]))
        self.assertEqual(1954, s.robotSim(
